               ...
               <br></br>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $no = 0;
                    $query = mysqli_query($koneksi,"SELECT * FROM tb_kajian LIMIT 1");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="index2.php?page=edit-data-kajian&& id=<?php echo $kj['id']; ?>" class="btn btn-sm btn-success">Edit</a>
                    </td>
                  </tr>
                  <?php  } ?>
                  </tbody>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method = "get" action="add/tambah_kajian.php">
