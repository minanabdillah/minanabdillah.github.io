               ...
               <br></br>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $no = 0;
                    $query = mysqli_query($koneksi,"SELECT * FROM tb_extra LIMIT 3");
                  ...
                  <tr>
                    ...
                    <td><a onclick="hapus_data(<?php echo $ex['id']; ?>)" class="btn btn-sm btn-danger">Hapus</a></td>
                  </tr>
                  <?php  } ?>
                  </tbody>
                  <tfoot>
                  <tr>
                    <th>Tambahkan Extrakulikuler yang wajib diikuti oleh Mahasantri Maksimal 3 Extrakulikuler</th>
                  </tr>
                  </tfoot>
                </table>
              </div>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method = "get" action="add/tambah_extra3.php">
...
<script>
  function hapus_data(data_id){
    ...
    if (result.isConfirmed) {
      window.location=("delete/hapus_dataextra3.php?id="+data_id);
    }
    })
  }
</script>